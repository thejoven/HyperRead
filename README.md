...
[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/thejoven/HyperRead/releases)
...
[![Download](https://img.shields.io/badge/Download-HyperRead%201.0.0-blue?style=for-the-badge&logo=apple)](https://github.com/thejoven/HyperRead/releases/latest)

</div>

1. 下载 `HyperRead-1.0.0-arm64.dmg` 安装包
2. 双击 DMG 文件
