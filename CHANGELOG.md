...
### Changed
- Updated the packaged AI Assistant demo plugin settings UI.
- Documented installable demo plugin zip packages in the README.

## [5.6.3] - 2026-05-27

### Added
- Added a macOS settings action to set HyperRead as the default app for Markdown and PDF documents.
